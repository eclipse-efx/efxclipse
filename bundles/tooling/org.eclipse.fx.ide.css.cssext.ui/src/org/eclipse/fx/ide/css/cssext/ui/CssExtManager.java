...
//	 */
//	@Override
//	public PropertyDefinition findPropertyByName(java.net.URI resource, EObject context, final String propertyName) {
//		List<PropertyDefinition> search = new SearchHelper(collectModels(resource, context)).findPropertiesByFilter(new PropertyDefinitionFilter() {
//			
//			@Override
...
//	
//	@Override
//	public List<PropertyDefinition> findPropertiesBySelector(java.net.URI resource, EObject context, selector cssSelector) {
...
//				
//				superElements.addAll(new SearchHelper(collectModels(resource, context)).findObjects(new SearchFilter<ElementDefinition>() {
//					@Override
...
//	
//	@Override
//	public List<PropertyDefinition> findAllProperties(java.net.URI resource, EObject context) {
//		List<PropertyDefinition> defs = new SearchHelper(collectModels(resource, context)).findPropertiesByFilter(new PropertyDefinitionFilter() {
//			
//			@Override
//			public boolean returnOnFirstHit() {
//				return false;
...
//	
//	@Override
//	public ElementDefinition findElementByName(java.net.URI resource, EObject context, final String elName) {
//		List<ElementDefinition> search = new SearchHelper(collectModels(resource, context)).findObjects(new SearchFilter<ElementDefinition>() {
//			
//			@Override
//			public Class<ElementDefinition> getSearchClass() {
//				return ElementDefinition.class;
...
//	
//	@Override
//	public ElementDefinition findElementByStyleClass(java.net.URI resource, EObject context, final String styleClass) {
//		List<ElementDefinition> r = new SearchHelper(collectModels(resource, context)).findObjects(new SearchFilter<ElementDefinition>() {
//			@Override
//			public Class<ElementDefinition> getSearchClass() {
//				return ElementDefinition.class;
//			}
...
//	
//	@Override
//	public CSSRule resolveReference(java.net.URI resource, EObject context, final CSSRuleRef ref) {
...
//	
//	@Override
//	public List<Proposal> getContributedProposalsForRule(java.net.URI resource, String fqRuleName) {
