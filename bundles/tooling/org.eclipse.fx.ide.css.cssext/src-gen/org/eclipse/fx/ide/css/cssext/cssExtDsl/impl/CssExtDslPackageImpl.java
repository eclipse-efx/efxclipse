...
public class CssExtDslPackageImpl extends EPackageImpl implements CssExtDslPackage
{
   ...
   * @generated
   */
  private EClass cssPropertyRefEClass = null;
   ...
   * @generated
   */
  public EAttribute getCssExtension_Namespace()
  {
    return (EAttribute)cssExtensionEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EReference)cssExtensionEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EClass getCSSPropertyRef()
  {
    return cssPropertyRefEClass;
  }
   ...
   * @generated
   */
  public EReference getCSSPropertyRef_Rule()
  {
    return (EReference)cssPropertyRefEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(cssExtensionEClass, CSS_EXTENSION__NAMESPACE);
    ...
    cssPropertyRefEClass = createEClass(CSS_PROPERTY_REF);
    createEReference(cssPropertyRefEClass, CSS_PROPERTY_REF__RULE);
  ...
  public void initializePackageContents()
  {
    ...
    cssPropertyRefEClass.getESuperTypes().add(this.getCSSType());
    ...
    initEAttribute(getCssExtension_Namespace(), ecorePackage.getEString(), "namespace", null, 0, 1, CssExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(cssPropertyRefEClass, CSSPropertyRef.class, "CSSPropertyRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCSSPropertyRef_Rule(), this.getCSSRuleRef(), null, "rule", null, 0, 1, CSSPropertyRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
