...
public class CssExtDslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected CssExtDslSwitch<Adapter> modelSwitch =
    new CssExtDslSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseCSSPropertyRef(CSSPropertyRef object)
      {
        return createCSSPropertyRefAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.fx.ide.css.cssext.cssExtDsl.CSSPropertyRef <em>CSS Property Ref</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createCSSPropertyRefAdapter()
  {
    return null;
  }
