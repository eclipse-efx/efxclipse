...
public class CssExtDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        CSSPropertyRef cssPropertyRef = (CSSPropertyRef)theEObject;
        T result = caseCSSPropertyRef(cssPropertyRef);
        if (result == null) result = caseCSSType(cssPropertyRef);
        if (result == null) result = caseCSSRule(cssPropertyRef);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>CSS Property Ref</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>CSS Property Ref</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseCSSPropertyRef(CSSPropertyRef object)
  {
    return null;
  }
