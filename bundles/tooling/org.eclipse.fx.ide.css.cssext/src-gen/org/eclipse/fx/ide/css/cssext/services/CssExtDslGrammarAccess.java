...
public class CssExtDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CssExtensionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cPackageDefAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cPackageDefPackageDefinitionParserRuleCall_3_0 = (RuleCall)cPackageDefAssignment_3.eContents().get(0);
		...
		//'namespace' namespace=STRING imports+=Import* packageDef=PackageDefinition?
		...
		//packageDef=PackageDefinition?
		public Assignment getPackageDefAssignment_3() { return cPackageDefAssignment_3; }
		
		//PackageDefinition
		public RuleCall getPackageDefPackageDefinitionParserRuleCall_3_0() { return cPackageDefPackageDefinitionParserRuleCall_3_0; }
	}
	...
	public class CSSTypeElements extends AbstractParserRuleElementFinder {
		...
		private final Action cCSSPropertyRefAction_2_0 = (Action)cGroup_2.eContents().get(0);
		private final Group cGroup_2_1 = (Group)cGroup_2.eContents().get(1);
		private final Assignment cDokuAssignment_2_1_0 = (Assignment)cGroup_2_1.eContents().get(0);
		private final RuleCall cDokuDokuParserRuleCall_2_1_0_0 = (RuleCall)cDokuAssignment_2_1_0.eContents().get(0);
		...
		private final Keyword cTypePROPERTY_REFKeyword_2_2_0 = (Keyword)cTypeAssignment_2_2.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_2_3 = (Keyword)cGroup_2.eContents().get(3);
		private final Assignment cRuleAssignment_2_4 = (Assignment)cGroup_2.eContents().get(4);
		private final RuleCall cRuleCSSRuleRefParserRuleCall_2_4_0 = (RuleCall)cRuleAssignment_2_4.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_2_5 = (Keyword)cGroup_2.eContents().get(5);
		private final Group cGroup_3 = (Group)cAlternatives.eContents().get(3);
		private final Group cGroup_3_0 = (Group)cGroup_3.eContents().get(0);
		private final Assignment cDokuAssignment_3_0_0 = (Assignment)cGroup_3_0.eContents().get(0);
		private final RuleCall cDokuDokuParserRuleCall_3_0_0_0 = (RuleCall)cDokuAssignment_3_0_0.eContents().get(0);
		private final RuleCall cWSTerminalRuleCall_3_0_1 = (RuleCall)cGroup_3_0.eContents().get(1);
		private final Alternatives cAlternatives_3_1 = (Alternatives)cGroup_3.eContents().get(1);
		private final Group cGroup_3_1_0 = (Group)cAlternatives_3_1.eContents().get(0);
		private final Assignment cTypeAssignment_3_1_0_0 = (Assignment)cGroup_3_1_0.eContents().get(0);
		private final Keyword cTypeINTKeyword_3_1_0_0_0 = (Keyword)cTypeAssignment_3_1_0_0.eContents().get(0);
		...
		private final Assignment cTypeAssignment_3_1_1_0 = (Assignment)cGroup_3_1_1.eContents().get(0);
		private final Keyword cTypeNUMKeyword_3_1_1_0_0 = (Keyword)cTypeAssignment_3_1_1_0.eContents().get(0);
		...
		private final Assignment cTypeAssignment_3_1_2_0 = (Assignment)cGroup_3_1_2.eContents().get(0);
		private final Keyword cTypeSTRINGKeyword_3_1_2_0_0 = (Keyword)cTypeAssignment_3_1_2_0.eContents().get(0);
		private final RuleCall cWSTerminalRuleCall_3_1_2_1 = (RuleCall)cGroup_3_1_2.eContents().get(1);
		private final Group cGroup_3_1_3 = (Group)cAlternatives_3_1.eContents().get(3);
		private final Assignment cTypeAssignment_3_1_3_0 = (Assignment)cGroup_3_1_3.eContents().get(0);
		private final Keyword cTypeURLKeyword_3_1_3_0_0 = (Keyword)cTypeAssignment_3_1_3_0.eContents().get(0);
		private final RuleCall cWSTerminalRuleCall_3_1_3_1 = (RuleCall)cGroup_3_1_3.eContents().get(1);
		...
		//	(doku=Doku WS*)? type='@NUM' '(' WS* from=DOUBLE WS* '->' WS* to=DOUBLE WS* ')' | {CSSPropertyRef} (doku=Doku WS*)?
		//	type='@PROPERTY_REF' '(' rule=CSSRuleRef ')' | (doku=Doku WS*)? (type='@INT' WS* | type='@NUM' WS* | type='@STRING'
		//	WS* | type='@URL' WS*);
		@Override public ParserRule getRule() { return rule; }
		
		//{CSSRangedIntType} (doku=Doku WS*)? type='@INT' '(' WS* from=INT WS* '->' WS* to=INT WS* ')' | {CSSRangedDoubleType}
		//(doku=Doku WS*)? type='@NUM' '(' WS* from=DOUBLE WS* '->' WS* to=DOUBLE WS* ')' | {CSSPropertyRef} (doku=Doku WS*)?
		//type='@PROPERTY_REF' '(' rule=CSSRuleRef ')' | (doku=Doku WS*)? (type='@INT' WS* | type='@NUM' WS* | type='@STRING' WS*
		//| type='@URL' WS*)
		...
		//{CSSPropertyRef} (doku=Doku WS*)? type='@PROPERTY_REF' '(' rule=CSSRuleRef ')'
		public Group getGroup_2() { return cGroup_2; }
		
		//{CSSPropertyRef}
		public Action getCSSPropertyRefAction_2_0() { return cCSSPropertyRefAction_2_0; }
		
		//(doku=Doku WS*)?
		public Group getGroup_2_1() { return cGroup_2_1; }
		
		//doku=Doku
		public Assignment getDokuAssignment_2_1_0() { return cDokuAssignment_2_1_0; }
		
		//Doku
		public RuleCall getDokuDokuParserRuleCall_2_1_0_0() { return cDokuDokuParserRuleCall_2_1_0_0; }
		...
		//'@PROPERTY_REF'
		public Keyword getTypePROPERTY_REFKeyword_2_2_0() { return cTypePROPERTY_REFKeyword_2_2_0; }
		
		//'('
		public Keyword getLeftParenthesisKeyword_2_3() { return cLeftParenthesisKeyword_2_3; }
		
		//rule=CSSRuleRef
		public Assignment getRuleAssignment_2_4() { return cRuleAssignment_2_4; }
		
		//CSSRuleRef
		public RuleCall getRuleCSSRuleRefParserRuleCall_2_4_0() { return cRuleCSSRuleRefParserRuleCall_2_4_0; }
		...
		//doku=Doku
		public Assignment getDokuAssignment_3_0_0() { return cDokuAssignment_3_0_0; }
		
		//Doku
		public RuleCall getDokuDokuParserRuleCall_3_0_0_0() { return cDokuDokuParserRuleCall_3_0_0_0; }
		
		//WS*
		public RuleCall getWSTerminalRuleCall_3_0_1() { return cWSTerminalRuleCall_3_0_1; }
		...
		//type='@INT'
		public Assignment getTypeAssignment_3_1_0_0() { return cTypeAssignment_3_1_0_0; }
		
		//'@INT'
		public Keyword getTypeINTKeyword_3_1_0_0_0() { return cTypeINTKeyword_3_1_0_0_0; }
		...
		//type='@NUM'
		public Assignment getTypeAssignment_3_1_1_0() { return cTypeAssignment_3_1_1_0; }
		
		//'@NUM'
		public Keyword getTypeNUMKeyword_3_1_1_0_0() { return cTypeNUMKeyword_3_1_1_0_0; }
		...
		//'@STRING'
		public Keyword getTypeSTRINGKeyword_3_1_2_0_0() { return cTypeSTRINGKeyword_3_1_2_0_0; }
		
		//WS*
		public RuleCall getWSTerminalRuleCall_3_1_2_1() { return cWSTerminalRuleCall_3_1_2_1; }
		
		//type='@URL' WS*
		public Group getGroup_3_1_3() { return cGroup_3_1_3; }
		
		//type='@URL'
		public Assignment getTypeAssignment_3_1_3_0() { return cTypeAssignment_3_1_3_0; }
		
		//'@URL'
		public Keyword getTypeURLKeyword_3_1_3_0_0() { return cTypeURLKeyword_3_1_3_0_0; }
		
		//WS*
		public RuleCall getWSTerminalRuleCall_3_1_3_1() { return cWSTerminalRuleCall_3_1_3_1; }
	}
