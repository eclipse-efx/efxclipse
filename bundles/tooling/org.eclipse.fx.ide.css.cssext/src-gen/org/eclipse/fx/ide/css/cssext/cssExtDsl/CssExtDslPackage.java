...
public interface CssExtDslPackage extends EPackage
{
   ...
   * @ordered
   */
  int CSS_EXTENSION__NAMESPACE = 0;
   ...
   * @ordered
   */
  int CSS_EXTENSION__PACKAGE_DEF = 2;
   ...
   * @ordered
   */
  int CSS_EXTENSION_FEATURE_COUNT = 3;
  ...
  /**
   * The meta object id for the '{@link org.eclipse.fx.ide.css.cssext.cssExtDsl.impl.CSSPropertyRefImpl <em>CSS Property Ref</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipse.fx.ide.css.cssext.cssExtDsl.impl.CSSPropertyRefImpl
   * @see org.eclipse.fx.ide.css.cssext.cssExtDsl.impl.CssExtDslPackageImpl#getCSSPropertyRef()
   * @generated
   */
  int CSS_PROPERTY_REF = 16;
   ...
   * @ordered
   */
  int CSS_PROPERTY_REF__DOKU = CSS_TYPE__DOKU;
   ...
   * @ordered
   */
  int CSS_PROPERTY_REF__TYPE = CSS_TYPE__TYPE;
   ...
   * @ordered
   */
  int CSS_PROPERTY_REF__RULE = CSS_TYPE_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>CSS Property Ref</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int CSS_PROPERTY_REF_FEATURE_COUNT = CSS_TYPE_FEATURE_COUNT + 1;
   ...
   * @generated
   */
  int CSS_RULE_CONCAT_WITHOUT_SPACE = 23;
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.fx.ide.css.cssext.cssExtDsl.CssExtension#getNamespace <em>Namespace</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Namespace</em>'.
   * @see org.eclipse.fx.ide.css.cssext.cssExtDsl.CssExtension#getNamespace()
   * @see #getCssExtension()
   * @generated
   */
  EAttribute getCssExtension_Namespace();
  ...
  /**
   * Returns the meta object for class '{@link org.eclipse.fx.ide.css.cssext.cssExtDsl.CSSPropertyRef <em>CSS Property Ref</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>CSS Property Ref</em>'.
   * @see org.eclipse.fx.ide.css.cssext.cssExtDsl.CSSPropertyRef
   * @generated
   */
  EClass getCSSPropertyRef();

  /**
   * Returns the meta object for the containment reference '{@link org.eclipse.fx.ide.css.cssext.cssExtDsl.CSSPropertyRef#getRule <em>Rule</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Rule</em>'.
   * @see org.eclipse.fx.ide.css.cssext.cssExtDsl.CSSPropertyRef#getRule()
   * @see #getCSSPropertyRef()
   * @generated
   */
  EReference getCSSPropertyRef_Rule();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute CSS_EXTENSION__NAMESPACE = eINSTANCE.getCssExtension_Namespace();
    ...
    /**
     * The meta object literal for the '{@link org.eclipse.fx.ide.css.cssext.cssExtDsl.impl.CSSPropertyRefImpl <em>CSS Property Ref</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipse.fx.ide.css.cssext.cssExtDsl.impl.CSSPropertyRefImpl
     * @see org.eclipse.fx.ide.css.cssext.cssExtDsl.impl.CssExtDslPackageImpl#getCSSPropertyRef()
     * @generated
     */
    EClass CSS_PROPERTY_REF = eINSTANCE.getCSSPropertyRef();
     ...
     * @generated
     */
    EReference CSS_PROPERTY_REF__RULE = eINSTANCE.getCSSPropertyRef_Rule();
