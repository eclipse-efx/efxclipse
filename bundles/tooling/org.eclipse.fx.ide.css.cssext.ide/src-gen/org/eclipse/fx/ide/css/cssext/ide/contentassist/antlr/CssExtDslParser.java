 ...
 */
package org.eclipse.fx.ide.css.cssext.ide.contentassist.antlr;
...
import org.eclipse.fx.ide.css.cssext.ide.contentassist.antlr.internal.InternalCssExtDslParser;
...
public class CssExtDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalCssExtDslParser createParser() {
		InternalCssExtDslParser result = new InternalCssExtDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCSSTypeAccess().getAlternatives_3_1(), "rule__CSSType__Alternatives_3_1");
					...
					put(grammarAccess.getCSSTypeAccess().getGroup_2_1(), "rule__CSSType__Group_2_1__0");
					put(grammarAccess.getCSSTypeAccess().getGroup_3(), "rule__CSSType__Group_3__0");
					put(grammarAccess.getCSSTypeAccess().getGroup_3_0(), "rule__CSSType__Group_3_0__0");
					put(grammarAccess.getCSSTypeAccess().getGroup_3_1_0(), "rule__CSSType__Group_3_1_0__0");
					put(grammarAccess.getCSSTypeAccess().getGroup_3_1_1(), "rule__CSSType__Group_3_1_1__0");
					put(grammarAccess.getCSSTypeAccess().getGroup_3_1_2(), "rule__CSSType__Group_3_1_2__0");
					put(grammarAccess.getCSSTypeAccess().getGroup_3_1_3(), "rule__CSSType__Group_3_1_3__0");
					...
					put(grammarAccess.getCssExtensionAccess().getNamespaceAssignment_1(), "rule__CssExtension__NamespaceAssignment_1");
					put(grammarAccess.getCssExtensionAccess().getImportsAssignment_2(), "rule__CssExtension__ImportsAssignment_2");
					put(grammarAccess.getCssExtensionAccess().getPackageDefAssignment_3(), "rule__CssExtension__PackageDefAssignment_3");
					...
					put(grammarAccess.getCSSTypeAccess().getDokuAssignment_2_1_0(), "rule__CSSType__DokuAssignment_2_1_0");
					put(grammarAccess.getCSSTypeAccess().getTypeAssignment_2_2(), "rule__CSSType__TypeAssignment_2_2");
					put(grammarAccess.getCSSTypeAccess().getRuleAssignment_2_4(), "rule__CSSType__RuleAssignment_2_4");
					put(grammarAccess.getCSSTypeAccess().getDokuAssignment_3_0_0(), "rule__CSSType__DokuAssignment_3_0_0");
					put(grammarAccess.getCSSTypeAccess().getTypeAssignment_3_1_0_0(), "rule__CSSType__TypeAssignment_3_1_0_0");
					put(grammarAccess.getCSSTypeAccess().getTypeAssignment_3_1_1_0(), "rule__CSSType__TypeAssignment_3_1_1_0");
					put(grammarAccess.getCSSTypeAccess().getTypeAssignment_3_1_2_0(), "rule__CSSType__TypeAssignment_3_1_2_0");
					put(grammarAccess.getCSSTypeAccess().getTypeAssignment_3_1_3_0(), "rule__CSSType__TypeAssignment_3_1_3_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalCssExtDslParser typedParser = (InternalCssExtDslParser) parser;
